...
if(isset($_POST['add_product'])){
   ...
   $stock = mysqli_real_escape_string($conn, $_POST['stock']); // Capture stock
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p class="stock">Stock: <?php echo $fetch_products['stock']; ?></p>
         
         <!-- Form to update stock -->
         <form action="" method="POST">
            <input type="hidden" name="product_id" value="<?php echo $fetch_products['id']; ?>">
            <input type="number" name="new_stock" min="0" value="<?php echo $fetch_products['stock']; ?>" class="box">
            <input type="submit" name="update_stock" value="Update Stock" class="btn">
         </form>
